...
class TestImageProcessingEdgeCases:
    ...
    def test_zero_stress_cases(self, test_parameters):
        ...
        delta_zero = compute_retardance(0, 0, 0, test_parameters['C_values'][0], 
                                       test_parameters['nu'], test_parameters['L'], 
    ...
    def test_extreme_values(self, test_parameters):
        ...
        try:
            delta_large = compute_retardance(large_stress, 0, 0, test_parameters['C_values'][0],
                                           test_parameters['nu'], test_parameters['L'],
                                           test_parameters['wavelengths'][0])
